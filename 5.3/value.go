...
var lValueNames = [...]string{"nil", "boolean", "integer", "number", "string", "function", "userdata", "thread", "table", "channel"}
...
func (nl *LNilType) assertInt64() (int64, bool)         { return 0, false }
...
func (nm LInteger) String() string {
	return fmt.Sprint(int64(nm))
}

func (nm LInteger) Type() LValueType                   { return LTInteger }
func (nm LInteger) assertFloat64() (float64, bool)     { return float64(nm), true }
func (nm LInteger) assertInt64() (int64, bool)         { return int64(nm), true }
func (nm LInteger) assertString() (string, bool)       { return "", false }
func (nm LInteger) assertFunction() (*LFunction, bool) { return nil, false }

// fmt.Formatter interface
func (nm LInteger) Format(f fmt.State, c rune) {
	switch c {
	case 'q', 's':
		defaultFormat(nm.String(), f, c)
	case 'b', 'c', 'd', 'o', 'x', 'X', 'U':
